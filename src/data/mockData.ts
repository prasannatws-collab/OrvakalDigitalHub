...
export interface FlightInfo {
  ...
  arrival: string;
  days: LocalizedText;
  status: LocalizedText; // On Time / Delayed
}
...
// Subcategory values:
// 'restaurant' | 'hotel' | 'rentals' | 'banquet' | 'tuitions' | 'boutique' | 'clothing' |
// 'wholesaler' | 'hardware' | 'stationery' | 'event-rental' | 'car-rental' | 'driving-school' | 
// 'medical' | 'dairy' | 'water-supplier' | 'laundry'
export interface CommercialShop {
  ...
  capacity?: number; // For banquet halls
  priceRate?: LocalizedText; // For rental prices
  image?: string;
}
